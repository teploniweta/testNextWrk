...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header
      className={`bg-white dark:bg-[var(--white)] shadow-sm ${className}`}
    >
              ...
              >
                <div className="absolute top-full left-0 mt-1 w-48 bg-white dark:bg-[var(--white)] border border-gray-200 dark:border-[var(--item-border-color)] rounded-md shadow-lg z-10">
                  <div className="py-1">
                    <a
                      href="#"
                      className="block px-4 py-2 text-sm text-gray-700 dark:text-[var(--text-secondary)] hover:bg-gray-100 dark:hover:bg-[var(--item-border-color)]"
                    >
                      Правила
                    </a>
                    <a
